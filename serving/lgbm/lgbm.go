...
// недетерминизма между запусками (см. docs/DESIGN.md, "Выбор: примитивы
// конкуренции"); параллелизм держим на уровне Go через Pool. Аллоцируется один раз на весь процесс, чтобы
